        ...
        NavigationStack {
            VStack(alignment: .leading, spacing: 0) {
                ...
                ZStack(alignment: .leading) {
                    ...
                    .submitLabel(.done)
                    .onSubmit {
                        if !viewModel.uiState.isLoading && !viewModel.uiState.nexonApiKey.isEmpty {
                ...
                Button(action: {
                    ...
                    .frame(height: 64)
                    .background(viewModel.uiState.isLoading || viewModel.uiState.nexonApiKey.isEmpty ? Color.mapleGray : Color.mapleBlack)
                    .foregroundColor(.white)
                    .cornerRadius(16)
                }
                .disabled(viewModel.uiState.isLoading || viewModel.uiState.nexonApiKey.isEmpty)
